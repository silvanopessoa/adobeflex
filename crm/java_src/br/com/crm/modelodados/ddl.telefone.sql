...
create table tb_telefone(
    id		                    	number(18,0)     	not null         constraint pk_telefone primary key,
    ...
    id_pessoa                    	number(18,0)     	not null--fk(rg) -- heder
);

create table tb_telefone_tipo(
    id				            	number(18,0)     	not null         constraint pk_telefone_tipo primary key,
...
alter table tb_telefone 	add constraint fk_telefone_tipo		foreign key(id_telefone_tipo)		references tb_telefone_tipo(id);
alter table tb_telefone 	add constraint fk_telefone_pessoa 	foreign key(id_pessoa) 				references tb_pessoa(id);
