...
create table tb_documento(
	id							number(18,0)		not null		constraint pk_documento primary key,
...
create table tb_documento_tipo(
	id									number(18,0)		not null		constraint pk_documento_tipo primary key,
...
-- FOREIGN KEY
alter table tb_documento add constraint fk_documento		foreign key(id_documento_tipo) 		references tb_documento_tipo(id);
