...
create table tb_matricula(
    id			                 number(18,0)     not null         constraint pk_matricula primary key,
...
create table tb_matricula_situacao(
    id					          number(18,0)     not null         constraint pk_matricula_situacao primary key,
...
-- FOREIGN KEY
alter table tb_matricula add constraint fk_matricula_situacao foreign key(id_matricula_situacao) references tb_matricula_situacao(id);
