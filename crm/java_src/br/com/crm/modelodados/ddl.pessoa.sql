...
create table tb_pessoa(
    id		                    number(18,0)     not null        	constraint pk_pessoa primary key,
...
create table tb_pessoa_especial(
    id				            		number(18,0)     not null	constraint pk_pessoa_especial primary key,--pk
...
create table tb_pessoa_especial_tipo(
    id        		number(18,0)     not null	constraint pk_pessoa_especial_tipo primary key,--pk
...
-- FOREIGN KEY
alter table tb_pessoa_especial 	add constraint fk_pessoa_especial 		foreign key(id_pessoa) 				 references tb_pessoa(id);
alter table tb_pessoa_especial 	add constraint fk_pessoa_especial_tipo 	foreign key(id_pessoa_especial_tipo) references tb_pessoa_especial_tipo(id);

-- CHECK
alter table tb_pessoa add constraint ck_pessoa_tipo check(in_tipo in('F','J'));
-- F = Fisica
-- J = Juridica
