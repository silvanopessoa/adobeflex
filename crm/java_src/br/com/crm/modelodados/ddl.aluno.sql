...
-- PRIMARY KEY
alter table tb_aluno                 	add constraint pk_aluno                 primary key(id);

-- SEQUENCE
create sequence crm.sq_aluno            increment by 1 start with 100;

-- FOREIGN KEY
alter table tb_aluno add constraint fk_aluno_pessoa foreign key(id_pessoa) references tb_pessoa(id);
