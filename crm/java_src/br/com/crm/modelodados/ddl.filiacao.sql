...
-- PRIMARY KEY
alter table tb_filiacao add constraint pk_filiacao primary key(id);
alter table tb_tutor add constraint pk_tutor primary key(id);

-- FOREIGN KEY
alter table tb_filiacao add constraint fk_filiacao_tutor foreign key(id_tutor) references tb_tutor(id);
alter table tb_filiacao add constraint fk_filiacao_pessoa foreign key(id_pessoa) references tb_pessoa(id);
